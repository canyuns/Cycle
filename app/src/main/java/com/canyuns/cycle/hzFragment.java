...
public class hzFragment extends ListFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  
        ...
        for (int i = 0; i < routeStrings.TITLES.length; i++) {
            Map<String, Object> item = new HashMap<>();
            item.put("image", routeStrings.ICONS[i]);
            item.put("text", routeStrings.TITLES[i]);
            items.add(item);
        }
